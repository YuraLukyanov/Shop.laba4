...
<body>
	<div class="menu">
		...
		<ul>
			...
			<li><a href="${pageContext.request.contextPath}/adddevice"
			...
			<li><a href="${pageContext.request.contextPath}/removecomponent"
				class="menu_link">Remove component</a></li>
			<li><a href="${pageContext.request.contextPath}/removedevices"
