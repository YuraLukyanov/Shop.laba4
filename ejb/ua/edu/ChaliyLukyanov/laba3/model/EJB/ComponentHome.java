...
public interface ComponentHome extends EJBHome {
	...
	public Component findByPrimaryKey(Integer id) throws FinderException, RemoteException;

	public List<Component> findAllComponents() throws FinderException, RemoteException;
